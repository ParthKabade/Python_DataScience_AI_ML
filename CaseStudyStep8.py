...
#######################################################################################################
"""
या point वर model अजून शिकलेला नाही.
हे फक्त model तयार करणे आहे.
Model Creation ≠ Model Training
"""
model=DecisionTreeClassifier(max_depth=5)

print("Module gets created succesfully")
...
#######################################################################################################
#step 8:teest the model
#######################################################################################################

print(Border)
print("step 8:teest the model")
print(Border)

Y_pred=model.predict(X_test)

print("Model testing succesfully")
